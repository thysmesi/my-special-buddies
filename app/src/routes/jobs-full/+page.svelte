<script>
    var loading = false
    var email, certifications, name, phone, bio, location, favoriteActivities
...
<main class="flex flex-col items-center px-12 sm:px-24 pt-24">
    <h2 class="mb-5 font-bold font-header pt-10 text-4xl text-center text-accent max-w-[850px]">Example Profile</h2>
    <img src="/images/jobs/item-1.webp" alt="" srcset="">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        <div class="space-y-4">
                            ...
                            <input bind:this={phone} type="text" name="phone" id="phone" placeholder="Phone Number" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:accent-secondary focus:accent-secondary block w-full p-2.5 " required="">
                            ...
                            <input bind:this={certifications} type="password" name="password" id="password" placeholder="Certifications" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:accent-secondary focus:accent-secondary block w-full p-2.5 " required="">
                        ...
                        <button on:click={onConfirmForm} class="w-full text-white bg-accent hover:bg-accent-secondary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Apply</button>
                    </div>
                </div>
                {#if loading} 
